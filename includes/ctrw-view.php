...
class CTRW_Review_View {
    ...
    include CTRW_PLUGIN_PATH . 'includes/views/admin/datatable/ctrw-reviews-list.php';
    include CTRW_PLUGIN_PATH . 'includes/views/admin/datatable/ctrw-reply-popup.php';
    include CTRW_PLUGIN_PATH . 'includes/views/admin/datatable/ctrw-review-update-popup.php';
    include CTRW_PLUGIN_PATH . 'includes/views/admin/datatable/ctrw-import-popup.php';
