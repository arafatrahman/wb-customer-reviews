...
<div class="">
    <!-- Slider View -->
    <div class="ctrw-review-list slider">
        <div class="ctrw-review-slider" id="ctrw-reviewSlider">
            <?php 
        ...
        <div class="ctrw-slider-nav" id="ctrw-sliderNav">
            <?php for ($i = 0; $i < min(count($reviews), $reviews_per_page); $i++) : ?>
                <div class="ctrw-slider-dot <?php echo $i === 0 ? 'active' : ''; ?>" data-slide="<?php echo $i; ?>"></div>
            <?php endfor; ?>
        </div>
        <?php endif; ?>
    </div>
