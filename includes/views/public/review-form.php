        ...
        <div class="ctrw-review-form-container">
            ...
            <form id="ctrw-reviewForm" method="post">
                <div class="ctrw-form-group">
                    ...
                    <input type="text" id="ctrw-name" class="ctrw-form-control" required>
                </div>
                
                <div class="ctrw-form-group">
                    <label for="ctrw-email" class="ctrw-form-label">Email Address</label>
                    <input type="email" id="ctrw-email" class="ctrw-form-control" required>
                </div>

                <div class="ctrw-form-group">
                    <label for="ctrw-phone" class="ctrw-form-label">Phone Number</label>
                    <input type="tel" id="ctrw-phone" class="ctrw-form-control" pattern="[0-9+\-\s()]{7,20}" maxlength="20">
                </div>

                <div class="ctrw-form-group">
                    <label for="ctrw-website" class="ctrw-form-label">Website</label>
                    <input type="url" id="ctrw-website" class="ctrw-form-control" placeholder="https://example.com">
                </div>
                <div class="ctrw-form-group">
                    <label for="ctrw-city" class="ctrw-form-label">City</label>
                    <input type="text" id="ctrw-city" class="ctrw-form-control">
                </div>

                <div class="ctrw-form-group">
                    <label for="ctrw-state" class="ctrw-form-label">State</label>
                    <input type="text" id="ctrw-state" class="ctrw-form-control">
                </div>

                <div class="ctrw-form-group">
                    <label for="ctrw-title" class="ctrw-form-label">Review Title</label>
                    <input type="text" id="ctrw-title" class="ctrw-form-control" required>
                </div>
                
                <div class="ctrw-form-group">
                    <label for="ctrw-review" class="ctrw-form-label">Comment</label>
                    <textarea id="ctrw-review" class="ctrw-form-control" required></textarea>
                </div>
                ...
                <div class="ctrw-form-group">
                    ...
                    <div class="ctrw-rating-input">
                        ...
                        <input type="hidden" id="ctrw-rating" name="ctrw-rating" value="0">
                    </div>
                </div>
